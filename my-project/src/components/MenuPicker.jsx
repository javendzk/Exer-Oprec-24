...
export default function MenuPicker() {
    ...
    return (
        <div className='flex flex-col justify-center items-center'>
            ...
            <motion.h1 id="MenuPicker" variants={fadeInAnimation}  initial="before" whileInView="after" viewport={{ once:true }} className='mt-24 text-4xl text-black font-poppins'>Available Services</motion.h1>
            <div className='flex flex-col h-auto width_45 mt-12 mb-36 items-center'>
                <div className='flex flex-row justify-center items-center'>
                    <NavLink to="/currency">
                        <motion.div variants={fadeUpAnimation} whileHover="hover" initial="before" whileInView="after" viewport={{ once:true }} style={{ width: '325px' }} className='h-86 mr-8 bg-gray-100 rounded-2xl border_1 border-gray-300 flex flex-col items-center hover:bg-gray-200 hover:border-gray-400 duration-300'>
                    ...
                    <NavLink to="/temperature">
                        <motion.div  variants={fadeUpAnimation} whileHover="hover" initial="before" whileInView="after" viewport={{ once:true }} style={{ width: '325px' }} className='h-86 ml-8 bg-gray-100 hover:bg-gray-200 hover:border-gray-400 rounded-2xl border_1 border-gray-300 flex flex-col items-center duration-300'>
                ...
                <NavLink to="https://youtube.com">
                    <motion.div variants={fadeUpAnimation} whileHover="hover" initial="before" whileInView="after" viewport={{ once:true }} style={{ width: '450px' }} className='mt-10 width_bottomcard bg-gray-100 hover:bg-gray-200 hover:border-gray-400 rounded-2xl border_1 border-gray-300 flex flex-row items-center duration-300 h-40'>
